...
def swiglu(x):
    ...
    Reference: "SwiGLU: A Gated Linear Unit Activation Function for Neural Networks" paper: https://arxiv.org/abs/2106.10818
    """
...
class GPTConfig:
    ...
    rotary: bool = True  # rotary attention network
    hyena: bool = False  # attention free network
